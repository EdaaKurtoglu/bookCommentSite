...
<hr style="border:1px solid; background-color:#8a7b6d; border-color:#3B3131;">
    ...
    <a href="#comment"   onclick="showComments()" ><i class="fa fa-th"></i> Comments</a>
    <a href="#log"   onclick="showLog()" ><i class="fa fa-th-large"></i> Log Move</a>

    <a href="../profile.php"   ><i class="fa fa-th"></i> Return Blog</a>
  <!---->
</div>
